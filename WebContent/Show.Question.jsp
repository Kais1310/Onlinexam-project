            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                     ...
                     <div class="question2">
                         <h2>*Q<c:out value="${question.question_id}" />:  <c:out value="${question.content}" /></h2> 
                       
                               <p>a)  <c:out value="${question.choice1}" /></p>
                               <p>b)  <c:out value="${question.choice2}" /></p>
                               <p>c)  <c:out value="${question.choice3}" /></p>
                               <p>d)  <c:out value="${question.choice4}" /></p>
                               <br>
                               <br>
                              
                               <h4>* The right answer : <c:out value="${question.right_answer}" />.</h4>
