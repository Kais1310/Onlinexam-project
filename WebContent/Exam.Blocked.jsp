            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                     ...
                     <div class="question">
                         <h2>The Exam is Blocked succesfully</h2>
                       <p>Now the topic is close and the students can not practice in the exam</p>
                       <a href="GetSession?doctorID=<c:out value="${doctor.doctor_id}" />">Back</a>
