...
<div class="d-flex" id="wrapper">
   ...
   <div id="page-content-wrapper">
          ...
          <div class="Formule"> 
                   ...
                   <input type="hidden" name="question_id" value="<c:out value="${question.question_id}"/>">
        ...
        <div class="first2">
            ...
            <br><br>
             ...
             <div class="second2">
                 <label>Choice4<h4>*</h4></label><br>
                 <input type="text"  name="choice4" value="<c:out value="${question.choice4}"/>" required="required"/>
            <br><br>
            
                <label>Right answer<h4>*</h4></label> <br>
                <input type="text"   name="right_answer" value="<c:out value="${question.right_answer}"/>" required="required"/>
            <br><br>
