...
<body>
 <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="row my-5">
                    <h2>Département  <c:out value="${student.department}" /></h2>
                    <h2>List of Planning Exams for <c:out value="${student.level}" />  <c:out value="${student.speciality}" /></h2> 
