        ...
        <div id="page-content-wrapper">
          ...
          <div class="Formule"> 
             <form  action="CreateSession" method="post">
                 ...
                 <p>you need to enter the informations of the Session </p>
                 <div class="first">
                     <label>Exam </label>
                          <select class="role" name="exam" required="required"  > 
                               <option ></option>
                     ...
                     <label>Date</label>
                       ...
                       Get the link of meeting  <a style="text-decoration: none;" href="https://meet.google.com/" target="_blank">Google meet</a> : <input type="text" name="meet_link" required="required" placeholder="coller le lien ici">
                        <br><br>
