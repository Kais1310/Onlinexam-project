                                 ...
                                 <c:forEach var="question" items="${ListQuestions}">
						             <tr>
							            ...
							            <td></td>
						             	...
						             	<td><a href="Edit_Question?question_id=<c:out value='${question.question_id}' /> "><i class="bi bi-gear"></i></a> / <a href="Delete_Question?question_id=<c:out value='${question.question_id}'/> "> <i class="bi bi-trash3"></i></a></td>
						             </tr>
				            	</c:forEach>
