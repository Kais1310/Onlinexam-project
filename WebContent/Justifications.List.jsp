...
<head>
  ...
  <link rel="stylesheet" href="Style.Justi.css" />
    ...
    <title>Justifications List</title>
                ...
                <div class="row my-5">
                    ...
                    <div class="col4">
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                 <c:forEach var="justification" items="${JustificationList}">
                                  
                                      <tr>
                                        <th scope="row"><c:out value="${justification.firstname}" />  <c:out value="${justification.lastname}"/></th>
                                        <td><c:out value="${justification.level}"/>    <c:out value="${justification.speciality}"/></td>
                                        <td>Added a justification :<h8><c:out value=" ${justification.date_ajoute}"/></h8><h8 style="color: #dddddd"></td>
                                        <td><a href="Show_Justification?justification_id=<c:out value="${justification.justification_id}"/>">Show</a></td>
                                        <td><a href="Delete_Justification?justification_id=<c:out value='${justification.justification_id}'/> "> <i class="bi bi-trash3"></i></a></td>
