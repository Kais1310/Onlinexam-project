...
<head>
<meta charset="UTF-8">
<title>List Students participated</title>
  <meta charset="UTF-8" />
      ...
      <div class="bg-white" id="sidebar-wrapper">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
              ...
              <div class="table3">
                    <h2>Students Participated list</h2> 
                    <br>
                    <div class="col">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="student" items="${ListStudents}">
                                    <tr>
                                     ...
                                     <td><c:out value="${student.level}" />  <c:out value="${student.speciality}" /></td>                         
                                     <td><a href="Show_Students_Answers?studentID=<c:out value="${student.student_id}"/>&examID=<c:out value="${exam.exam_id}"/>" ><i class="bi bi-eye"></i>Show</a></td>  
                                     </tr>
                                 </c:forEach>
