                  ...
                  <% i = i + 1;  %>
                     <div class="question">
                         ...
                         <h2>*Q :  <c:out value="${topic.question}" /></h2> 
                               ...
                               <p>a)  <input type="checkbox">  <c:out value="${topic.choice1}" /> </p>
                               <p>b)  <input type="checkbox">  <c:out value="${topic.choice2}" /></p>
                               <p>c)  <input type="checkbox">  <c:out value="${topic.choice3}" /> </p>
                               <p>d)  <input type="checkbox">  <c:out value="${topic.choice4}" /> </p>
