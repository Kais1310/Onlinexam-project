                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="reclamation" items="${ListReclamations}">
                                    <tr>
                                     <th scope="row"><c:out value="${reclamation.reclamation_id}" /></th>
                                     <td><c:out value="${reclamation.firstname}" /></td>   
                                     <td><c:out value="${reclamation.lastname}" /></td>     
                                     <td>ajouter reclamation á :  <c:out value="${reclamation.date}" /></td>  
                                     <td><c:out value="${reclamation.module}" /></td>
                                     <td><c:out value="${reclamation.note}" /></td>                       
                                     <td><a href="Delete_Reclamation?reclamation_id=<c:out value="${reclamation.reclamation_id}"/>" >Delete</a></td>  
                                     </tr>
                                 </c:forEach>
