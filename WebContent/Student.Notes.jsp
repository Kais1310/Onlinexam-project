                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                 ...
                                 <c:forEach var="note" items="${ListNotes}">
						             <tr>
						                <th scope="row"><c:out value="${note.note_id}" /></th>
						              	<td><c:out value="${note.module}" /></td>			              	
							            <td><c:out value="${note.note}" /></td>	
							            <td></td>
							            <td></td>
							            <td><a href="Add_Reclamation?firstname=<c:out value="${student.firstname}" />&lastname=<c:out value="${student.lastname}" />&module=<c:out value="${note.module}" />&note=<c:out value="${note.note}" />&studentID=<c:out value="${student.student_id}" />">Reclamation</a></td>
							             <td></td>
