...
<div class="all3">
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <form action="List_Doctors" method="get" >  <input type="search" placeholder="search.." name="search" class="search"  >
                    </form>
                     
                        <button>
                    <a href ="Create_Doctor"><i class="bi bi-plus-circle"></i>  Add Doctor</a></button>
