...
<title>Annoncements</title>
    ...
    <link rel="stylesheet" href="Annonce.Style.css" />
    <link rel="stylesheet" href="Annonce.Form.css" />
        ...
        <div class="container">
         <div class="boxi">
            <div class="cardi">
              ...
              <h5><c:out value="${annonce.titre}" /></h5>
              <div class="pra">
                <p><c:out value="${annonce.date_ajoute}" /></p>
                <p><a href="ShowAnnonce?annonce_id=<c:out value="${annonce.annonce_id}" />">Show</a></p>
