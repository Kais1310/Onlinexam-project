            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                     ...
                     <div class="question">
                         <h2 style="color:black;">The Session is Created succesfully</h2> 
                       
                       <button class="btn6"><a href ="GetSession?doctorID=<c:out value="${doctor.doctor_id}" />"><i class="bi bi-plus-circle"></i>Show Session</a></button>
