...
<div class="d-flex" id="wrapper">
  ...
  <form action="AddJustification" method="post" enctype="multipart/form-data">
  <h2>Add  justification</h2>
     ...
     <input type="hidden" name="level" value="<c:out value="${student.level}"/>">

     <input type="hidden" name="speciality" value="<c:out value="${student.speciality}"/>">
     <input type="hidden" name="group" value="<c:out value="${student.group}"/>">
    ...
    <input type="text" name="module" placeholder="module">
     ...
     <input type="date" name="date_absence" placeholder="date_absence"><br><br>
       <label>Seance</label>
          <select class="role" name="seance" required="required"  > 
               <option ></option>
               <option >Exam</option>
               <option >Td</option>
               <option >Tp</option>
 ...
 <div class="second4">
     ...
     <input type="text" name="justification"placeholder="tap the reason of absence">
     <input type="hidden" name="studentID" value="<c:out value="${student.student_id}"/>"><br><br>
     <label>Select File</label>
     <input type="file" name="file" >
     <br><br>
     </div>
     <br><br> <br>
     <input type="submit" class="btn4" value="Upload" />
</form>
